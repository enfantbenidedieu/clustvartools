...
def get_sup_label(X,indexes=None,axis=0):
    ...
    indexes : None, int, str, list, tuple, range, default = None
        Indicating the indexes or names of the supplementary elements (rows or columns).

    axis : None, str, int, default = 0
        Indicating which axis to aggregate
    ...
    --------
    label : None, list 
        Indicating the the names of the supplementary elements.
    """
    #---------------------------------------------------------------------------------------------------------------------------------------------------------------------
