...
#interns functions
from ..clustering.functions.utils import is_dataframe, is_series, is_namedtuple, is_dict
...
def save(obj, 
         ...
         **kwargs):
    """
    Print results for clustering of variables model in an Excel sheet

    Parameters
    ----------
    obj : class
        A fitted cluster analysis model.
    ...
    **kwargs: dict
    ...
    all_attr = ["call_","coef_","cluster_","levels_","levels_sup_","quali_var_",
                "quali_var_sup_","quanti_var_","quanti_var_sup_","var_","var_sup_"]
